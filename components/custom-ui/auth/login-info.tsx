...
export function LoginInfo() {
  return (
    <Alert className="mt-8 glass-card" variant="default">
      <Terminal className="h-4 w-4" />
      <AlertTitle className="glass-card-title">
        AWS S3 Access Configuration Guide
      </AlertTitle>
      <AlertDescription>
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="config-steps">
            {" "}
            <AccordionTrigger className="gradient-text">
              Configuration Steps
            </AccordionTrigger>
            <AccordionContent>
