  ...
  const renderStatus = () => {
    if (status === "loading") {
      return (
        <span className="text-gray-600 dark:text-gray-400 font-medium flex items-center">
          ...
          {!isCollapsed && <span className="ml-2">Connecting...</span>}
        </span>
      );
    }
    ...
    if (status === "SUCCESS") {
      return (
        <span className="text-green-600 dark:text-green-400 font-medium flex items-center">
          ...
          {!isCollapsed && <span className="ml-2">Connected to server</span>}
        </span>
      );
    }
    ...
    return (
      <span className="text-red-600 dark:text-red-400 font-medium flex items-center">
        ...
        {!isCollapsed && <span className="ml-2">Connection failed</span>}
      </span>
    );
  };
